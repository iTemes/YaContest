...
- Яндекс. Тренировки по алгоритмам 2.0, занятие 5 (B) 🕓
  ...
  - D. [Каждому по компьютеру](https://github.com/iTemes/YaContest/tree/master/src/5/D-validBrackets) 🟠 (Сложное для понимания условие => больше попыток на устранение ошибок, сдача с 3 попытки)
