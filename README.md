...
- Яндекс. Тренировки по алгоритмам 2.0, занятие 5 (B) ✔️
  ...
  - Е. [Сумма трех](https://github.com/iTemes/YaContest/tree/master/src/5/E-sumOfThree) 🟡 (была проблема с вводом данных в систему проверки из-за других названий файлов)
